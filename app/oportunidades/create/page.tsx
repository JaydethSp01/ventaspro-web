...
export default function FormPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <PageHeader title="Nuevo Oportunidades" subtitle="Completa los datos y guarda." />
      <Card>
        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); router.push("/oportunidades"); }}>
          ...
          <div className="flex gap-2 pt-2">
            ...
            <Button type="button" variant="secondary" onClick={() => router.push("/oportunidades")}>Cancelar</Button>
          </div>
        </form>
      </Card>
    </div>
